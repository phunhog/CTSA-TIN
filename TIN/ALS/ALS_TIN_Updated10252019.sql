...
-- edited here 10/25/2019 for most recent ALS TIN request
WHERE 
HA.DISCH_DATE_TIME > TO_DATE(''05/31/2019'', ''MM/DD/YYYY'')
...
WHERE ARPB.SERVICE_DATE  > TO_DATE(''05/31/2019'', ''MM/DD/YYYY'') 
...
AND PE.CONTACT_DATE  > TO_DATE(''05/31/2019'', ''MM/DD/YYYY'') 
AND LOC.HOSP_PARENT_LOC_ID = 1010
AND Not ((PAT.PAT_STATUS_C =2) OR (PAT.PAT_STATUS_C IS Null))
and  (Sysdate - pat.Birth_Date) / 365.25 >= 18.00
--Order by MRN, encounter_ID
