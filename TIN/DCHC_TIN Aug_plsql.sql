...
from 
  ...
  AND (
		...
		and peh.CONTACT_DATE BETWEEN 
				TRUNC(to_date('01-jan-2019 00:00:00', 'dd-mon-yyyy hh24:mi:ss')) 
				AND TRUNC(to_date('30-jun-2019 00:00:00', 'dd-mon-yyyy hh24:mi:ss'))
